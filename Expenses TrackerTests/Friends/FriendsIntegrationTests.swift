...
class FriendsIntegrationTests: XCTestCase {
    ...
    func test_friendsList_reloadTableView_when_itemsLoaded() throws {
        ...
        XCTAssertEqual(sut.itemTitle(at: 0), f1.name, "friend name at row 0")
        XCTAssertEqual(sut.itemTitle(at: 1), f2.name, "friend name at row 1")
    }
    
    func test_friendsList_loadFailed_when_loadFriendsFailed() throws {
